...
- (void)viewDidLoad
{
    ...
    json_data=[NSArray arrayWithObjects:@"one",@"two",nil];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    {
        if ([segue.destinationViewController isKindOfClass:[FifthViewController class]]) {
            ...
            nextViewController.jsonArray=json_data;
